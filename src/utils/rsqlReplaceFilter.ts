...
export const rsqlReplaceFilter = (original: FilterItem, replace: FilterItem, search?: ExpressionNode): ExpressionNode | undefined => {
  ...
  if (!isSameRsqlFilter(original, search))
    return search
